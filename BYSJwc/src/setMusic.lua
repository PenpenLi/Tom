...
SetMusic = class("SetMusic", function()
    return cc.Layer:create()
end)

function SetMusic:create()
    local layer = SetMusic.new()
    layer:init()
    return layer
end

function SetMusic:createScene()
    local scene = cc.Scene:create()
    local layer = SetMusic:create()
    scene:addChild(layer)
    return scene
end

function SetMusic:init()
    -- 背景
    ...
    -- 标签
    local lb = cc.MenuItemFont:create("声音")
    lb:setEnabled(false)
    -- 开关按钮
