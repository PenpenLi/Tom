...
function Bullet:create(speed, weapon, attackMode, type, typeOfEnemyPlan)
    local bullet = Bullet.new()
    bullet:init(speed, weapon, attackMode, type, typeOfEnemyPlan)
    return bullet
end

function Bullet:init(speed, weapon, attackMode, type, typeOfEnemyPlan)
    ...
    if type == PLANE_BULLET_TYPE then   -- 玩家子弹
        ...
        self:setScale(enemyBulletConfig[typeOfEnemyPlan].sizeOfBullet)
